...
/*
* Class Exercici
* Aquesta classe representa un exercici d'una assignatura.
* Conté la descripció de l'exercici, la data límit de lliurament,
* 
*/
...
public:
	...
	int buscaNiuLliurament(const string& niu);
