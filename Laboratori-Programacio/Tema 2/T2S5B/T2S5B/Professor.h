...
public:
	...
	Professor(const string& niu, const string& nom, const string& departament) : m_departament(departament) { cout << "Constructor Parametres Professor" << endl; }
	Professor(const Professor& p) : m_departament(p.m_departament) { cout << "Constructor Copia Professor" << endl; }
