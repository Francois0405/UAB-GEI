...
int main()
{
	...
	cout << "Comment :=>> RESULTAT POTENCIA 1: potenciaRec(" << 5 << " , " << 3 << ") = " << endl;;
	float prec = potenciaRec(5, 3);
	if (prec == 125) {
		cout << "Comment :=>> CORRECTE calcul potencia: potenciaRec(" << 5 << " , " << 3 << ") = " << prec << endl;
		grade += 1.5;
	}
	else {
	...
	cout << "Comment :=>> ==================================================================" << endl;
	cout << "RESULTAT POTENCIA 2 : potencia(" << 5 << " , " << -3.0 << ") = " << endl;
	float prec1 = potencia(5, -3);
	if ((prec1 >= 0.008) && (prec1 <= 0.009)) {
		cout << "Comment :=>> CORRECTE calcul potencia: potencia(" << 5 << " , " << -3.0 << ") = " << prec1 << endl;
		grade += 1.5;
	}
	else {
		cout << "Comment :=>> ERROR RESULTAT FINAL    ....................... " << endl;
	...
	cout << "Comment :=>> ==================================================================" << endl;
	cout << "RESULTAT POTENCIA 2 potencia(" << 3 << " , " << 4 << ") = " << endl;
	float prec2 = potencia(3, 4);
	if (prec2 == 81) {
		cout << "Comment :=>> CORRECTE calcul potencia: potencia(" << 3 << " , " << 4 << ") = " << prec2 << endl;
		grade += 1.5;
	}
	else {
		cout << "Comment :=>> ERROR RESULTAT FINAL    ....................... " << endl;
	...
	if (res == 6543) {
		cout << "Comment :=>> CORRECTE calcul invertir numero: " << res << endl;
		grade += 4.0;
	}
	else {
		cout << "Comment :=>> ERROR RESULTAT FINAL    ....................... " << endl;
