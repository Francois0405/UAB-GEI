...
bool comparaCicle(string cicleEsperat[], const vector<vector<string>>& ciclesGraf, int posCicle)
{
	bool iguals = true;
	int i = 0;
	while (iguals && (i < 3))
...
bool comparaCicles(string ciclesEsperats[][3], const vector<vector<string>>& ciclesGraf, int nCiclesEsperats)
{
