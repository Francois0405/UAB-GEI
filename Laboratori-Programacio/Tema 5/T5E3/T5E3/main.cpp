...
void mostraNodes(const std::vector<string>& nodes)
{
	cout << "[";
	if (nodes.size() > 0)
	{
...
float testOrdreTasques()
{
	...
	stack<string> ordre;
	vector<string> ordreEsperat1, ordreEsperat2, ordreEsperat3;
	...
	ordreEsperat3 = { "Tasca 1", "Tasca 3", "Tasca 2", "Tasca 4", "Tasca 6", "Tasca 5", "Tasca 8", "Tasca 7", "Tasca 9", "Tasca 10", "Tasca 11" };
	...
	cout << "Comment :=>> -----" << endl;
	cout << "Comment :=>> Ordre de tasques esperat 1: ";
	mostraNodes(ordreEsperat1);
	cout << endl;
	cout << "Comment :=>> Ordre de tasques esperat 2 (alternatiu): ";
	mostraNodes(ordreEsperat2);
	cout << endl;
	cout << "Comment :=>> Ordre de tasques esperat 3 (alternatiu): ";
	mostraNodes(ordreEsperat3);
	...
	if ((ordreObtingut == ordreEsperat1) || (ordreObtingut == ordreEsperat2) || (ordreObtingut == ordreEsperat3))
		cout << "Comment :=>> CORRECTE" << endl;
	else
	{
		cout << "Comment :=>> ERROR" << endl;
